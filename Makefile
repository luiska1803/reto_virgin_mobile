...
validations: 
	uv run main.py --yaml ./pipelines/validaciones/validacion_campaign_gold.yaml --ver-cli
...
validations_git:
	...
	set -x
	uv run main.py --yaml ./pipelines/validaciones/validacion_campaign_gold.yaml || (echo "Error ejecutando validaciones"; exit 1)
